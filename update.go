...
const (
	archiveUrl = `https://my.atlassian.com/download/feeds/archived/stash.json`
	currentUrl = `https://my.atlassian.com/download/feeds/current/stash.json`
	eapUrl     = `https://my.atlassian.com/download/feeds/eap/stash.json`
)
